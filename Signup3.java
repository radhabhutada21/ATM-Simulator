...
public class Signup3 extends JFrame implements ActionListener{
    ...
    Signup3(String formno){
        ...
        scrollPane.setBounds(0, 0, 850, 850); // Set the size and position
        scrollPane.setVerticalScrollBarPolicy(JScrollPane.VERTICAL_SCROLLBAR_ALWAYS); // Show vertical scrollbar always

        // Add your existing components to the scroll pane
